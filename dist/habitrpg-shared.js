    ...
    user.fns = {
      ...
      */
      ...
      cron: function(options) {
        var clearBuffs, daysMissed, expTally, lvl, lvlDiv2, now, progress, todoTally, _base, _base1, _base2, _base3, _progress, _ref, _ref1, _ref2, _ref3, _ref4;
        ...
        clearBuffs = _.find(user.dailys, function(d) {
          ...
          stealth: 0,
          streaks: false
        } : ((_ref = (_base = user.achievements).perfect) != null ? _ref : _base.perfect = 0, user.achievements.perfect++, {
          str: lvlDiv2,
          int: lvlDiv2,
          per: lvlDiv2,
          con: lvlDiv2,
        ...
        todoTally = 0;
        if ((_ref1 = (_base1 = user.party.quest.progress).down) == null) {
          _base1.down = 0;
        }
        user.todos.concat(user.dailys).forEach(function(task) {
          var absVal, completed, delta, id, repeat, scheduleMisses, type, _ref2;
        ...
        ((_ref2 = (_base2 = ((_ref3 = user.history) != null ? _ref3 : user.history = {})).todos) != null ? _ref2 : _base2.todos = []).push({
          date: now,
          value: todoTally
        });
        ...
        ((_ref4 = (_base3 = user.history).exp) != null ? _ref4 : _base3.exp = []).push({
          date: now,
          value: expTally
        });
